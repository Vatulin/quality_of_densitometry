...
# efficientnet_b0 даёт +2-4% над resnet18 при том же размере
model = models.efficientnet_b0(weights=models.EfficientNet_B0_Weights.DEFAULT)
# первый слой под grayscale
...
new_conv = nn.Conv2d(1, old_conv.out_channels,
                     ...
                     bias=False)
# инициализируем средним по каналам — так не теряем pretrained информацию
with torch.no_grad():
